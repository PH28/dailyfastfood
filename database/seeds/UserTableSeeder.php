...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([
            ...
            ['first_name' => 'thanh', 'last_name' => 'thien', 'dob' => '1997-8-12', 'gender' => 'female', 'email' => 'thanhthuy1997@gmail.com', 'password' => bcrypt('123456'), 'phone' => '090544433', 'address' => '76 đống đa, đà nẵng', 'role_id' => 1, 'remember_token' => str_random(10)]
        ]);
    }
}
